 ...
 *
 * <code>
 *     for (int i = 0; (i = removals.nextSetBit(i)) >= 0; i++) {}
 * </code>
 */
public class BitVector {
	 ...
	 * @return Same as out
	 */
	public Bag<Integer> toIntBag(Bag<Integer> out) {
		if (isEmpty()) {
			out.setSize(0);
			return out;
		}
	...
	private int prepareBag(Bag<Integer> out, int elementsPerEntry) {
